...
import com.finrobotics.neyyasample.hue.quickstart.PHHomeActivity;
...
public class ConnectActivity extends AppCompatActivity {
    ...
    private Button mNameChangeButton, mLeftHandfButton, mRightHandButton, mSlowButton, mMediumButton, mFastButton, mHueButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHueButton = (Button) findViewById(R.id.launchHueButton);
